...
namespace detail
{
      ...
      protected:
        ...
        : m_value( detail::array_funcs<n_array>().copy_and_map( hgh_bit_pattern,
                                                                value ) )
        {}
                      ...
                      CharT                                            one )
        {
          ...
          auto const n_bits=
            std::min( N, std::min( n, str_sz - pos ) );
        ...
        {
          return
            ( m_value[bit / ullong_bits] &
              ull_left_shift( 1ull, bit % ullong_bits ) );
        }
